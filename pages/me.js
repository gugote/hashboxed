  ...
  return (
    <div className="content">
      <section className="container">
        ...
        <p>In 2014 I joined <a href="http://ring.com/" target="_blank">Ring.com</a> (employee number 11 I think), an IoT company which was acquired by Amazon in 2018. I was hired initially as a UI/UX designer and worked on the first design of the mobile app, first version of the website, creation of a styleguide, internal admin tools and billing/user accounts for 2 years. My role evolved and today I am a Frontend Lead Developer for all the Ecommerce portion of the site, working alongside the Design Team to help them reach the design interaction they want without forcing or compromising the code by doing crazy stuff to achieve those objectives and focusing on UX and UI improvements.</p>
        ...
        <h3>Personal Info</h3>
        <p>I live in Formosa, a small town in the nort of Argentina, 41 y/o, father of 3 awesome kids and best friend of the most grumpy puppie I know (Zelda)</p>
        <p>About my language, I can speak/write fluent English and Spanish.</p>
        <p>All the usual geek stuff is involved: Comics (specially graphic novels), Movies and Series (The Wire and 24 ❤️), Videogames (a ton of FIFA and COD), Music (yes, I have vynils.)</p>
